...
$config = [
    'controllers'        => [
        'factories' => [
            ...
            Controller\Question\QuestionManagerController::class => ConfigAbstractFactory::class,
        ],
    ],
    'service_manager'    => [
        'factories' => [
            ...
            Navigation\Invokable\Question\CategoryLabel::class => Factory\InvokableFactory::class,
            Navigation\Invokable\Question\QuestionLabel::class => Factory\InvokableFactory::class,
        ],
    ],
    'controller_plugins' => [
        'aliases'   => [
    ...
    'view_helpers'       => [
        'aliases'   => [
            ...
            'affiliationQuestionLink'         => View\Helper\Question\QuestionLink::class
        ],
        'factories' => [
            ...
            View\Helper\Question\QuestionLink::class => View\Factory\ViewHelperFactory::class,
        ],
    ],
    'view_manager'       => [
